...
class PictureViewModel {
    var pictures = [
        ...
        Picture(name: "penguin", category: "Animals", firstDominantColor: .cyan, secondDominantColor: .lightQuilt),
        ...
        Picture(name: "beaver", category: "Animals", firstDominantColor: .cyan, secondDominantColor: .lightQuilt),
